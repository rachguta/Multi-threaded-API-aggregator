...
public class CliManager {
    ...
    public API[] readApis() throws NoSuchElementException {
    ...
    public String readFormat() throws NoSuchElementException {
    ...
    public String readParameter(API api) throws NoSuchElementException {
    ...
    public String readFileName() throws NoSuchElementException {
    ...
    public API readApi() throws NoSuchElementException {
        List<String> apiNames = new ArrayList<>();
        for (API api : API.values()) {
            apiNames.add(api.name().toLowerCase());
        }
    ...
    public String readFileMode() throws NoSuchElementException {
        System.out.println("""
    ...
    public String readOutputMode() throws NoSuchElementException {
        System.out.println("""
    ...
    public int readMaxNumOfTasks() throws NoSuchElementException {
    ...
    public long readApiInterval() throws NoSuchElementException {
    ...
    public void readStartingPolling() throws NoSuchElementException {
        System.out.println("Press Enter to start the program...");
        in.nextLine();
    }

    public void readStoppingPolling() throws NoSuchElementException {
